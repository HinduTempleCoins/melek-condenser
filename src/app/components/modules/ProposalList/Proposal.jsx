...
Proposal.propTypes = {
  ...
  total_vesting_fund_blurt: PropTypes.string.isRequired
}
...
/**
 * Given total votes in vests returns value in BP
 ...
 * @param {string} total_vesting_fund_blurt - total steem vesting fund with liquid symbol on end
 * @returns {number} - return the number converted to BP
 */
