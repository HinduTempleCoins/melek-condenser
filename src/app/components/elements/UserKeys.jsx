            ...
            <div className="UserKeys">
                    ...
                    <div className="key__content-container">
                        <div className="key__col">
                            ...
                            <p className="key__description">
                                ...
                                to this key can take your tokens. Store this key
                                safely to avoid losing tokens in the future.
                            </p>
                ...
                <div className="key">
                    ...
                    <div className="key__content-container">
                        <div className="key__col">
                            <p className="key__description">
                                The only thing the Memo Key is used for is to
                                encrypt and decrypt private messages that are
                                sent through the blockchain. While this could
                                one day be a powerful feature, today it is not
                                commonly used. If you have received a private
                                message that you would like to decrypt, as
                                always you should use the key with the minimum
                                necessary authorities, which in this case would
                                be the Memo Key.
                            </p>
                            <Keys
                                account={account}
                    ...
                    <div className="public-keys__container">
                        <div className="public-keys__intro">
                            ...
                            <p className="public-keys__description">
                                ...
                                for login on blurt.blog and you don't need to
                                store these safely.
                            </p>
                            <p className="public-keys__description">
