                ...
                >
                    <div className="row">
                        <div className="columns">
                            <form>
                                <h3 className="text-center">Submit your proposal to the blockchain</h3>
                                <hr />

                                <label>A short title for your proposal</label>
                                <input onChange={this.handleTitleChange} placeholder="Enter a title like Cool Dapp" type="text" />
                                <br />

                                <label>Daily requested amount in Blurt</label>
                                <input onChange={this.handleDailyAmountChange} placeholder='100' type="text" pattern="[0-9.]+" />
                                <br />

                                <label>Start Date</label>
                                <DatePicker dateFormat="YYYY-MM-DD" timeFormat="hh:mm:ss" id="startDate" 
                                    onChange={(date) => this.handleStartDateChange(date)} value={this.state.proposalForm.startDate} />
                                <br />


                                <label>End Date</label>
                                <DatePicker dateFormat="YYYY-MM-DD" timeFormat="hh:mm:ss" id="endDate" 
                                    onChange={(date) => this.handleEndDateChange(date)} value={this.state.proposalForm.endDate} />
                                <br />

                                <label>Proposal Permalink</label>
                                <input onChange={this.handlePermalinkChange} placeholder="permalink" type="text" />
                                <small style={{color: 'red'}}>* Permalink is a URL from proposal description (Blurt post), i.e create-cool-app</small>
                                <br />

                                <label>Proposal Creator (10 BLURT submission fee required)</label>
                                <input onChange={this.handleCreatorChange} type="text" placeholder="Creator username"></input>
                                <small style={{color: 'red'}}>* Creator is a Blurt account that publishes a proposal</small>
                                <br />

                                <label>Proposal Receiver</label>
                                <input onChange={this.handleReceiverChange} placeholder="Receiver username" type="text" />
                                <small style={{color: 'red'}}>* Receiver is a Blurt account that receives funding for proposal</small>
                                <br />

                                <div className="text-center">
                                    <button type="button" className="button primary"
                                        onClick={() => submit_proposal(this.state.proposalForm)}>Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
