...
export const GET_INCOMING_VESTING_DELEGATIONS =
    'user/GET_INCOMING_VESTING_DELEGATIONS';
export const SET_INCOMING_VESTING_DELEGATIONS =
    'user/SET_INCOMING_VESTING_DELEGATIONS';
export const INCOMING_VESTING_DELEGATIONS_LOADING =
    'user/INCOMING_VESTING_DELEGATIONS_LOADING';
