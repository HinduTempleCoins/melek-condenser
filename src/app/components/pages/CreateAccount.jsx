                    ...
                    <div className="column">
                        ...
                        <div className="callout alert">
                            <p>
                                ...
                                approved yet or you already created an account.
                                <br />
                                Please try again later or contact{' '}
                                <a href="mailto:support@blurt.blog">
                                    support@blurt.blog
                                </a>{' '}
                            ...
                            </div>
                            {
                                ...
                                this.state.account_has_keys_warning && (
                                    <div className="warning">
                                        Please note: due to recent security
                                        changes if you chosen a password before
                                        during signup, this one below will
                                        override it — this is the one you need
                                        to save.
                                    </div>
                                )
                            }
