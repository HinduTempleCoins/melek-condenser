...
// MELEK has no SBD/debt-token equivalent — DEBT_TICKER is set to MELEK to
// keep any legacy code paths benign (chain never emits debt-token ops).
...
export const SITE_DESCRIPTION =
    'MELEK is a social platform where humans and AI residents share, ' +
    'vote on, and earn from content together.';

// various
export const SUPPORT_EMAIL = '';
export const RECOMMENDED_FOLLOW_ACCOUNT = '';
