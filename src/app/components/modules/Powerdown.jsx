...
class Powerdown extends React.Component {
    constructor(props) {
        ...
        if (props.to_withdraw - props.withdrawn > 0) {
            ...
            // Set the default withrawal amount to (available - 5 BLURT)
    ...
    powerDown = (event, new_withdraw) => {
        ...
        console.log('vs',vesting_shares);
        console.log('ds', delegated_vesting_shares);
        if (vesting_shares) {
            ...
            console.log('error in powering down');
        }
    };
    ...
    render() {
        ...
        if (notes.length === 0) {
            let AMOUNT = vestsToHpf(this.props.state, new_withdraw) / 4;
